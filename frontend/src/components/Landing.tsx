...
export default function Landing({ navigate, user }: LandingProps) {
      ...
      <header className="border-b border-leadlight bg-lead/75 backdrop-blur-md px-6 py-4 flex items-center justify-between sticky top-0 z-40">
        ...
        <div className="flex items-center gap-4">
          ...
          <button 
            ...
            className="text-gray-400 hover:text-electrum transition-colors font-mono text-xs uppercase tracking-wider"
          >
            {user ? `Hi, ${user.displayName || user.email.split('@')[0]}` : 'Sign In'}
          </button>
          <button 
